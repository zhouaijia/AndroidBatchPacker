...
class BatchPackerPlugin implements Plugin<Project> {

    public static final String sPluginExtensionName = "batchPacker";
...
//            compile 'com.aijia.batchpacker:packer_library:' + getVersion()
//        }
            ...
            while (resEnum.hasMoreElements()) {
                try {
                    ...
                    if (is != null) {
                        ...
                        final String version = mainAttribs.getValue("PatchPacker-Version");
                        if (version != null) {
                            return version;
                        }
                    }
